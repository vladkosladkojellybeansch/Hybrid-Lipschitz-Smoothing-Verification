...
frames_data = []
print("Evaluating formal verification bounds across 30 frames...")

# Simulate 30 steps of continuous data drift using a sin wave
...
print("Compiling animation pipeline...")
def animate(i):
...
# Generate the file explicitly forcing execution boundaries via PillowWriter
writer = PillowWriter(fps=12)
ani.save('robustness_animation.gif', writer=writer)

plt.close()
print("Success! 'robustness_animation.gif' has been successfully compiled.")
